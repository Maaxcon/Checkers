import type { MoveLogEntry, Position } from '../../types.ts';

export class HistoryView {
    #panel!: HTMLElement;
    #list!: HTMLUListElement;
    #onHistoryItemClick: ((from: Position, to: Position) => void) | null = null;

    constructor(container: HTMLElement) {
        this.#createLayout(container);
    }

    #createLayout(container: HTMLElement): void {
    ...
    bindClick(handler: (from: Position, to: Position) => void): void {
        this.#onHistoryItemClick = handler;
    }

    render(moveLog: MoveLogEntry[] = []): void {
