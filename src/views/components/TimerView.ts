...
import type { TimerTimes } from '../../types.ts';

export class TimerView {
    #container!: HTMLDivElement;
    #lightTime!: HTMLSpanElement;
    #darkTime!: HTMLSpanElement;
    #lightBox!: HTMLDivElement;
    #darkBox!: HTMLDivElement;

    constructor(parent: HTMLElement) {
        this.#createLayout(parent);
    }

    #createLayout(parent: HTMLElement): void {
    ...
    render(times: TimerTimes, activePlayer: Player): void {
